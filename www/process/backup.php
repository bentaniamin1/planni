...
function export_status()
{
    ...
    $fields=array('status_id','nom','commentaire','affichage','barre','gras','italique','souligne','affichage_filtre','defaut','affichage_liste','pourcentage','couleur','priorite');
    $sql="select status_id,nom,commentaire,affichage,barre,gras,italique,souligne,affichage_filtre,defaut,affichage_liste,pourcentage,couleur,priorite from planning_status";
