<?php
/* Smarty version 3.1.32, created on 2024-05-14 09:20:38
  from '/home/planning/public_html/templates/www_user_list.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.32',
  'unifunc' => 'content_664310c6d55203_27409387',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'ead0c212894c02da4b2e1c38deaef76c5c6d68f0' => 
    array (
      0 => '/home/planning/public_html/templates/www_user_list.tpl',
      1 => 1621576849,
      2 => 'file',
    ),
  ),
...
function content_664310c6d55203_27409387 (Smarty_Internal_Template $_smarty_tpl) {
...
/user_groupes.php" class="btn btn-default"><i class="fa fa-users fa-lg fa-fw" aria-hidden="true"></i>&nbsp;&nbsp;<?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'menuGroupesUsers');?>
				...
				<div class="btn-group">
					<form method="POST">
					<a href="#" class="btn <?php if (count($_smarty_tpl->tpl_vars['filtreEquipe']->value) > 0) {?>btn-danger<?php } else { ?>btn-default<?php }?> dropdown-toggle" data-toggle="dropdown" data-display="static"><?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'filtreEquipe');?>
...
" title="<?php echo htmlspecialchars($_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'planning_filtre_sur_user'), ENT_QUOTES, 'ISO-8859-1', true);?>
...
"><?php echo xss_protect($_smarty_tpl->tpl_vars['userTmp']->value['email']);?>
								...
								<td class="wrap d-none d-lg-table-cell text-center">
									...
									<?php $_smarty_tpl->_assignInScope('cooltip', ((($_smarty_tpl->tpl_vars['cooltip']->value).("<br>")).($_smarty_tpl->smarty->ext->configload->_getConfigVariable($_smarty_tpl, 'periode_date_creation'))).(" : "));?>
									<?php $_smarty_tpl->_assignInScope('dateCreation', sqldatetime2userdatetime($_smarty_tpl->tpl_vars['userTmp']->value['date_creation']));?>
									<?php $_smarty_tpl->_assignInScope('cooltip', ($_smarty_tpl->tpl_vars['cooltip']->value).($_smarty_tpl->tpl_vars['dateCreation']->value));?>
									<?php $_smarty_tpl->_assignInScope('cooltip', ((($_smarty_tpl->tpl_vars['cooltip']->value).("<br>")).($_smarty_tpl->smarty->ext->configload->_getConfigVariable($_smarty_tpl, 'periode_modifier'))).(" : "));?>
									<?php $_smarty_tpl->_assignInScope('dateModif', sqldatetime2userdatetime($_smarty_tpl->tpl_vars['userTmp']->value['date_modif']));?>
									<?php $_smarty_tpl->_assignInScope('cooltip', ($_smarty_tpl->tpl_vars['cooltip']->value).($_smarty_tpl->tpl_vars['dateModif']->value));?>
