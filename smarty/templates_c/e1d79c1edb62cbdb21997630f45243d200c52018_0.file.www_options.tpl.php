<?php
/* Smarty version 3.1.32, created on 2024-05-21 12:20:50
  from '/home/planning/public_html/templates/www_options.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.32',
  'unifunc' => 'content_664c7582bddf99_32359327',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'e1d79c1edb62cbdb21997630f45243d200c52018' => 
    array (
      0 => '/home/planning/public_html/templates/www_options.tpl',
      1 => 1618499582,
      2 => 'file',
    ),
  ),
...
function content_664c7582bddf99_32359327 (Smarty_Internal_Template $_smarty_tpl) {
	...
	<div class="form-group row col-md-12 mt-2" id="optionsRow">
		<div class="col-3">
			<div  class="nav flex-column nav-pills soplanning-box" role="tablist" aria-orientation="vertical" id="myTab">
				<a class="nav-link <?php if (!isset($_GET['tab']) || $_GET['tab'] == "params-global" || $_GET['tab'] == '') {?>active<?php }?>" id="param-global-tab" data-toggle="pill" href="#param-global" role="tab" aria-controls="param-global" aria-selected="true"><?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'options_configGenerale');?>
</a>
				<a class="nav-link <?php if (isset($_GET['tab']) && $_GET['tab'] == "param-modules") {?>active<?php }?>" id="param-modules-tab" data-toggle="pill" href="#param-modules" role="tab" aria-controls="param-modules" aria-selected="false"><?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'options_modules');?>
</a>
				<a class="nav-link <?php if (isset($_GET['tab']) && $_GET['tab'] == "param-planning") {?>active<?php }?>" id="param-planning-tab" data-toggle="pill" href="#param-planning" role="tab" aria-controls="param-planning" aria-selected="false"><?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'options_planning');?>
</a>
				<a class="nav-link <?php if (isset($_GET['tab']) && $_GET['tab'] == "param-taches") {?>active<?php }?>" id="param-taches-tab" data-toggle="pill" href="#param-taches" role="tab" aria-controls="param-taches" aria-selected="false"><?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'options_taches');?>
</a>
				<a class="nav-link <?php if (isset($_GET['tab']) && $_GET['tab'] == "param-divers") {?>active<?php }?>" id="param-divers-tab" data-toggle="pill" href="#param-divers" role="tab" aria-controls="param-divers" aria-selected="false"><?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'options_divers');?>
</a>
				<a class="nav-link <?php if (isset($_GET['tab']) && $_GET['tab'] == "param-smtp") {?>active<?php }?>" id="param-smtp-tab" data-toggle="pill" href="#param-smtp" role="tab" aria-controls="param-smtp" aria-selected="false"><?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'options_smtp');?>
</a>
				<a class="nav-link <?php if (isset($_GET['tab']) && $_GET['tab'] == "param-testmail") {?>active<?php }?>" id="param-testmail-tab" data-toggle="pill" href="#param-testmail" role="tab" aria-controls="param-testmail" aria-selected="false"><?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'options_envoyerMailTest');?>
</a>
				<a class="nav-link <?php if (isset($_GET['tab']) && $_GET['tab'] == "param-api") {?>active<?php }?>" id="param-api-tab" data-toggle="pill" href="#param-api" role="tab" aria-controls="param-api" aria-selected="false"><?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'options_api');?>
</a>
				<a class="nav-link <?php if (isset($_GET['tab']) && $_GET['tab'] == "google-login") {?>active<?php }?>" id="google-login-tab" data-toggle="pill" href="#google-login" role="tab" aria-controls="google-login" aria-selected="false"><?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'options_google_login');?>
</a>
				<a class="nav-link <?php if (isset($_GET['tab']) && $_GET['tab'] == "google-2fa") {?>active<?php }?>" id="google-2fa-tab" data-toggle="pill" href="#google-2fa" role="tab" aria-controls="google-2fa" aria-selected="false"><?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'options_2fa');?>
</a>
				<a class="nav-link <?php if (isset($_GET['tab']) && $_GET['tab'] == "param-audit") {?>active<?php }?>" id="param-audit-tab" data-toggle="pill" href="#param-audit" role="tab" aria-controls="param-audit" aria-selected="false"><?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'options_audit');?>
</a>
			</div >
		</div>
		<div class="col-9">
			<div class="soplanning-box">
				<div class="tab-content">
					<div class="tab-pane fade show <?php if (!isset($_GET['tab']) || $_GET['tab'] == 'param-global' || $_GET['tab'] == '') {?>active<?php }?>" id="param-global" role="tabpanel" aria-labelledby="param-global-tab">
...
"/>
					...
					<div class="tab-pane <?php if (isset($_GET['tab']) && $_GET['tab'] == "param-modules") {?>active<?php }?>"" id="param-modules">
...
"/>
					...
					<div class="tab-pane <?php if (isset($_GET['tab']) && $_GET['tab'] == "param-planning") {?>active<?php }?>"" id="param-planning">
						<form action="process/options.php" method="POST">
 ...
 :</label>
									<div class="col-3">
										<select name="PLANNING_DIFFERENCIE_WEEKEND" class="form-control">
											<option value="1" <?php if (@constant('CONFIG_PLANNING_DIFFERENCIE_WEEKEND') == 1) {?>selected="selected"<?php }?>><?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'options_differencier_weekend_1');?>
</option>
											<option value="0" <?php if (@constant('CONFIG_PLANNING_DIFFERENCIE_WEEKEND') == 0) {?>selected="selected"<?php }?>><?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'options_differencier_weekend_0');?>
</option>
										</select>
									</div>
...
"/>
					...
					<div class="tab-pane <?php if (isset($_GET['tab']) && $_GET['tab'] == "param-taches") {?>active<?php }?>"" id="param-taches">
...
"/>
					...
					<div class="tab-pane <?php if (isset($_GET['tab']) && $_GET['tab'] == "param-divers") {?>active<?php }?>"" id="param-divers">
						<form action="process/options.php" method="POST" class="form-horizontal">
...
" class="cursor-help tooltipster"><i class="fa fa-question-circle" aria-hidden="true"></i></div>
								...
								<div class="form-group row col-md-12 align-items-center">
									<label class="col-md-4 col-form-label"><?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'options_dureeCreneauHoraire');?>
 :</label>
									<div class="col-3">
										<select name="PLANNING_DUREE_CRENEAU_HORAIRE" class="form-control">
											<option value="2" <?php if (@constant('CONFIG_PLANNING_DUREE_CRENEAU_HORAIRE') == 2) {?>selected="selected"<?php }?>>2 <?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'minutes');?>
</option>
											<option value="5" <?php if (@constant('CONFIG_PLANNING_DUREE_CRENEAU_HORAIRE') == 5) {?>selected="selected"<?php }?>>5 <?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'minutes');?>
</option>
											<option value="10" <?php if (@constant('CONFIG_PLANNING_DUREE_CRENEAU_HORAIRE') == 10) {?>selected="selected"<?php }?>>10 <?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'minutes');?>
</option>
											<option value="15" <?php if (@constant('CONFIG_PLANNING_DUREE_CRENEAU_HORAIRE') == 15) {?>selected="selected"<?php }?>>15 <?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'minutes');?>
</option>
											<option value="20" <?php if (@constant('CONFIG_PLANNING_DUREE_CRENEAU_HORAIRE') == 20) {?>selected="selected"<?php }?>>20 <?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'minutes');?>
</option>
											<option value="30" <?php if (@constant('CONFIG_PLANNING_DUREE_CRENEAU_HORAIRE') == 30) {?>selected="selected"<?php }?>>30 <?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'minutes');?>
</option>
											<option value="60" <?php if (@constant('CONFIG_PLANNING_DUREE_CRENEAU_HORAIRE') == 60) {?>selected="selected"<?php }?>>1 <?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'heure');?>
</option>
											<option value="120" <?php if (@constant('CONFIG_PLANNING_DUREE_CRENEAU_HORAIRE') == 120) {?>selected="selected"<?php }?>>2 <?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'heures');?>
</option>
											<option value="180" <?php if (@constant('CONFIG_PLANNING_DUREE_CRENEAU_HORAIRE') == 180) {?>selected="selected"<?php }?>>3 <?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'heures');?>
</option>
											<option value="240" <?php if (@constant('CONFIG_PLANNING_DUREE_CRENEAU_HORAIRE') == 240) {?>selected="selected"<?php }?>>4 <?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'heures');?>
</option>
											<option value="300" <?php if (@constant('CONFIG_PLANNING_DUREE_CRENEAU_HORAIRE') == 300) {?>selected="selected"<?php }?>>5 <?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'heures');?>
</option>
											<option value="360" <?php if (@constant('CONFIG_PLANNING_DUREE_CRENEAU_HORAIRE') == 360) {?>selected="selected"<?php }?>>6 <?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'heures');?>
</option>
										</select>
									</div>
									<div title="<?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'options_aide_dureeCreneauHoraire');?>
" class="cursor-help tooltipster"><i class="fa fa-question-circle" aria-hidden="true"></i></div>
								</div>
...
"/>
					...
					<div class="tab-pane <?php if (isset($_GET['tab']) && $_GET['tab'] == "param-smtp") {?>active<?php }?>"" id="param-smtp">
						<form action="process/options.php" method="POST">
...
"/>
					...
					<div class="tab-pane <?php if (isset($_GET['tab']) && $_GET['tab'] == "param-testmail") {?>active<?php }?>"" id="param-testmail">
						<form action="process/options.php" method="POST" class="form-horizontal">
...
" <?php if (@constant('CONFIG_SMTP_HOST') == '' || @constant('CONFIG_SMTP_PORT') == '' || @constant('CONFIG_SMTP_FROM') == '') {?>disabled="disabled"<?php }?>/>
					...
					<div class="tab-pane <?php if (isset($_GET['tab']) && $_GET['tab'] == "param-api") {?>active<?php }?>"" id="param-api">
						<form action="process/options.php" method="POST" class="form-horizontal">
							<input type="hidden" name="tab" value="param-api">
							<fieldset>
								<legend>
									<?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'options_api');?>

								</legend>
								<div class="form-group row col-md-12 align-items-center">
									<label class="col-md-4 col-form-label"><?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'options_api_url');?>
 :</label>
									<div class="col-6">
										<?php if (@constant('CONFIG_SOPLANNING_URL') != '') {
echo @constant('CONFIG_SOPLANNING_URL');
} else { ?>SOPLANNING_URL<?php }?>/api/endpoint
									</div>
								</div>
								<div class="form-group row col-md-12 align-items-center">
									<label class="col-md-4 col-form-label"><?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'options_api_key');?>
 :</label>
									<div class="col-6">
										<input name="SOPLANNING_API_KEY_NAME" type="text" class="form-control" value="<?php echo xss_protect(@constant('CONFIG_SOPLANNING_API_KEY_NAME'));?>
" />
									</div>
								</div>
								<div class="form-group row col-md-12 align-items-center">
									<label class="col-md-4 col-form-label"><?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'options_api_value');?>
 :</label>
									<div class="col-6">
										<input name="SOPLANNING_API_KEY_VALUE" type="text" class="form-control" value="<?php echo xss_protect(@constant('CONFIG_SOPLANNING_API_KEY_VALUE'));?>
" />
									</div>
								</div>
								<div class="form-group row col-md-12 align-items-center">
									<label class="col-md-4 col-form-label"><?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'options_api_doc');?>
 :</label>
									<div class="col-6">
...
">
					...
					<div class="tab-pane <?php if (isset($_GET['tab']) && $_GET['tab'] == "google-login") {?>active<?php }?>" id="google-login">
						<form action="process/options.php" method="POST" class="form-horizontal">
							<input type="hidden" name="tab" value="google-login">
							<fieldset>
								<legend>
									<?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'options_google_login');?>

								</legend>
								<div class="form-group row col-md-12 align-items-center">
									<label class="col-md-12 col-form-label" style="font-size:13px"><?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'options_google_login_help');?>
</label>
								</div>
								<div class="form-group row col-md-12 align-items-center">
									<label class="col-md-6 col-form-label"><?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'google_sso_active');?>
 :</label>
									<div class="col-6">
										<input type="checkbox" name="GOOGLE_OAUTH_ACTIVE" id="GOOGLE_OAUTH_ACTIVE" <?php if (@constant('CONFIG_GOOGLE_OAUTH_ACTIVE') == 1) {?>checked="checked"<?php }?> value="1">
									</div>
								</div>
								<div class="form-group row col-md-12 align-items-center">
									<label class="col-md-6 col-form-label"><?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'google_sso_return_url');?>
 :</label>
									<div class="col-6">
										<?php if (@constant('CONFIG_SOPLANNING_URL') == '') {?>
											<?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'google_sso_return_url_need_setup');?>

										<?php } else { ?>
											<?php echo @constant('CONFIG_SOPLANNING_URL');?>

										<?php }?>
									</div>
								</div>
								<div class="form-group row col-md-12 align-items-center">
									<label class="col-md-6 col-form-label"><?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'google_sso_client_id');?>
 :</label>
									<div class="col-6">
										<input name="GOOGLE_OAUTH_CLIENT_ID" type="text" class="form-control" value="<?php echo xss_protect(@constant('CONFIG_GOOGLE_OAUTH_CLIENT_ID'));?>
" />
									</div>
								</div>
								<div class="form-group row col-md-12 align-items-center">
									<label class="col-md-6 col-form-label"><?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'google_sso_secret');?>
 :</label>
									<div class="col-6">
										<input name="GOOGLE_OAUTH_CLIENT_SECRET" type="text" class="form-control" value="<?php echo xss_protect(@constant('CONFIG_GOOGLE_OAUTH_CLIENT_SECRET'));?>
" />
									</div>
								</div>
								<div class="form-group row col-md-12 align-items-center">
...
">
					...
					<div class="tab-pane <?php if (isset($_GET['tab']) && $_GET['tab'] == "google-2fa") {?>active<?php }?>" id="google-2fa">
						<form action="process/options.php" method="POST" class="form-horizontal">
							<input type="hidden" name="tab" value="google-2fa">
							<fieldset>
								<legend>
									<?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'options_2fa');?>

								</legend>
								<div class="form-group row col-md-12 align-items-center">
									<label class="col-md-12 col-form-label" style="font-size:13px"><?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'options_2fa_help');?>
</label>
								</div>
								<div class="form-group row col-md-12 align-items-center">
									<label class="col-md-6 col-form-label"><?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'google_2fa_active');?>
 :</label>
									<div class="col-6">
										<input type="checkbox" name="GOOGLE_2FA_ACTIVE" id="GOOGLE_2FA_ACTIVE" <?php if (@constant('CONFIG_GOOGLE_2FA_ACTIVE') == 1) {?>checked="checked"<?php }?> value="1">
									</div>
								</div>
								<div class="form-group row col-md-12 align-items-center">
									<div class="col-md-6"></div>
...
">
					...
					<div class="tab-pane <?php if (isset($_GET['tab']) && $_GET['tab'] == "param-audit") {?>active<?php }?>" id="param-audit">
						<form action="process/options.php" method="POST" class="form-horizontal">
