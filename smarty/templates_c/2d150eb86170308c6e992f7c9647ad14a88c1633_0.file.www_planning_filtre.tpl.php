...
/* Smarty version 3.1.32, created on 2024-05-14 09:04:02
  from '/home/planning/public_html/templates/www_planning_filtre.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.32',
  'unifunc' => 'content_66430ce2d13370_81017452',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '2d150eb86170308c6e992f7c9647ad14a88c1633' => 
    array (
      0 => '/home/planning/public_html/templates/www_planning_filtre.tpl',
      1 => 1603874318,
      2 => 'file',
    ),
  ),
...
function content_66430ce2d13370_81017452 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_checkPlugins(array(0=>array('file'=>'/home/planning/public_html/smarty/libs/plugins/function.math.php','function'=>'smarty_function_math',),1=>array('file'=>'/home/planning/public_html/smarty/libs/plugins/modifier.replace.php','function'=>'smarty_modifier_replace',),));
...
" onClick="document.location='process/planning.php?raccourci_date=aujourdhui'" id="buttonDateNowSelector"><i class="fa fa-home fa-lg fa-fw" aria-hidden="true"></i></a>
						...
						<a href="#" id="buttonDateSelector" class="btn dropdown-toggle btn-default" data-toggle="dropdown">
							<b>
							<span class="d-none d-sm-inline-block"><?php echo $_smarty_tpl->tpl_vars['dateDebutTexte1']->value;?>
&nbsp;</span><?php echo $_smarty_tpl->tpl_vars['dateDebutTexte2']->value;?>

							<?php if ($_smarty_tpl->tpl_vars['baseLigne']->value != "heures") {?>
								- <span class="d-none d-sm-inline-block"><?php echo $_smarty_tpl->tpl_vars['dateFinTexte1']->value;?>
&nbsp;</span><?php echo $_smarty_tpl->tpl_vars['dateFinTexte2']->value;?>
...
';" id="buttonDatePrevSelector"><i class="fa fa-chevron-left fa-lg fa-fw" aria-hidden="true"></i><span class="d-none d-xl-inline-block"><?php echo $_smarty_tpl->tpl_vars['dateBoutonInferieur']->value;?>
</span></a>
						<a class="btn btn-default" onClick="document.location='process/planning.php?raccourci_date=+<?php echo $_smarty_tpl->tpl_vars['nbJours']->value;?>
';" id="buttonDateNextSelector"><span class="d-none d-xl-inline-block"><?php echo $_smarty_tpl->tpl_vars['dateBoutonSuperieur']->value;?>
</span> <i class="fa fa-chevron-right fa-lg fa-fw" aria-hidden="true"></i></a>
					</div>
					<?php if (!in_array("tasks_readonly",$_smarty_tpl->tpl_vars['user']->value['tabDroits'])) {?>
						<div class="btn-group ml-md-4 pt-2" id="btnAddTask">
							<a class="btn btn-info" href="javascript:Reloader.stopRefresh();xajax_ajoutPeriode();undefined;">
								...
								<span class="d-none d-xl-inline-block" ><?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'menuAjouterPeriode');?>
</span>
							</a>
						</div>
					<?php }?>
		...
		<div class="vw-100 position-fixed" id="secondLayer">
			<div class="soplanning-box form-inline pt-0" id="divPlanningMainFilter">
						...
						<button class="btn dropdown-toggle btn-default" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-display="static" ><i class="fa fa-calendar fa-lg fa-fw" aria-hidden="true"></i><span class="d-none d-md-inline-block">&nbsp;&nbsp;<?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'planning_affichage');?>
...
&afficherLigneTotal=1">
								<i style="margin-left:19px;">&nbsp;</i>
							<?php }?>
							<?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'planningAfficherTotal');?>
</a>
...
&afficherLigneTotalTaches=1">
								<i style="margin-left:19px;">&nbsp;</i>
							<?php }?>
							<?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'planningAfficherTotalTaches');?>
</a>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
						...
						<form action="process/planning.php" method="POST">
						<button class="btn <?php if ((count($_smarty_tpl->tpl_vars['filtreGroupeLieu']->value) > 0) || (count($_smarty_tpl->tpl_vars['filtreGroupeRessource']->value) > 0)) {?>btn-danger<?php } else { ?>btn-default<?php }?> dropdown-toggle" data-toggle="dropdown" onclick="javascript:multiselecthide();" data-display="static"><i class="fa fa-flask fa-lg fa-fw" aria-hidden="true"></i><span class="d-none d-xl-inline-block">&nbsp;<?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'filtres_avances');?>
&nbsp;</span><span class="caret"></span></button>
						<ul class="dropdown-menu">
							<li>
								<input type="submit" value="<?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'submit');?>
" class="btn btn-default ml-2" />
								<?php if ((count($_smarty_tpl->tpl_vars['filtreGroupeLieu']->value) > 0) || (count($_smarty_tpl->tpl_vars['filtreGroupeRessource']->value) > 0)) {?><a href="process/planning.php?desactiverFiltreAvances=1" class="btn btn-danger btn-sm margin-left-10"><?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'formFiltreAvancesDesactiver');?>
</a><?php }?>
							</li>
							<li class="divider"></li>
							<li>
...
" <?php if (in_array($_smarty_tpl->tpl_vars['statust']->value['status_id'],$_smarty_tpl->tpl_vars['filtreStatutTache']->value) || count($_smarty_tpl->tpl_vars['filtreStatutTache']->value) == 0) {?>checked="checked"<?php }?> />&nbsp;<?php echo $_smarty_tpl->tpl_vars['statust']->value['nom'];?>
...
" <?php if (in_array($_smarty_tpl->tpl_vars['statusp']->value['status_id'],$_smarty_tpl->tpl_vars['filtreStatutProjet']->value) || count($_smarty_tpl->tpl_vars['filtreStatutProjet']->value) == 0) {?>checked="checked"<?php }?> />&nbsp;<?php echo $_smarty_tpl->tpl_vars['statusp']->value['nom'];?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
						...
						<button class="btn dropdown-toggle btn-default" data-toggle="dropdown" onclick="javascript:multiselecthide();"><i class="fa fa-sort-amount-desc fa-lg fa-fw" aria-hidden="true"></i><span class="d-none d-xl-inline-block">&nbsp;&nbsp;<?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'formTrierPar');?>
</span>&nbsp;<span class="caret"></span></button>
						<div class="dropdown-menu">
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
						...
						<button class="btn dropdown-toggle btn-default" data-toggle="dropdown" onclick="javascript:multiselecthide();"><i class="fa fa-cloud-download fa-lg fa-fw" aria-hidden="true"></i><span class="d-none d-xl-inline-block">&nbsp;&nbsp;<?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'choix_export');?>
</span>&nbsp;<span class="caret"></span></button>
						<div class="dropdown-menu" style="">
							...
							<a class="dropdown-item" href="export_csv_raw.php"><i class="fa fa-fw fa-file-text-o" aria-hidden="true"></i> <?php echo xss_protect($_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'CSVExportRaw'));?>
</a>
...
" maxlength="50" title="<?php echo htmlspecialchars($_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'formFiltreTexte'), ENT_QUOTES, 'ISO-8859-1', true);?>
" id="filtreTexte" />
