<?php
/* Smarty version 3.1.32, created on 2024-05-21 11:49:48
  from '/home/planning/public_html/templates/projet_form.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.32',
  'unifunc' => 'content_664c6e3cc36e05_07009087',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '4e91d396d48097961b061c86d6504a68b85da723' => 
    array (
      0 => '/home/planning/public_html/templates/projet_form.tpl',
      1 => 1603874318,
      2 => 'file',
    ),
  ),
...
function content_664c6e3cc36e05_07009087 (Smarty_Internal_Template $_smarty_tpl) {
...
');" />
 ...
 :</label>
		<div class="col-md-6">
			<input class="form-control" name="nom" id="nom" type="text" maxlength="50" value="<?php echo $_smarty_tpl->tpl_vars['projet']->value['nom'];?>
" />
		</div>
	</div>
	<div class="form-group row col-md-12">
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
 ...
 :</label>
		<div class="col-md-3">
			<input type="number" step="0.01" class="form-control" name="charge" id="charge" maxlength="5" value="<?php echo $_smarty_tpl->tpl_vars['projet']->value['charge'];?>
" />
		</div>
		<div class="col-md-3 left-0">
...
">
						<?php if ($_smarty_tpl->tpl_vars['projet']->value['couleur'] != '') {?><option value="<?php echo $_smarty_tpl->tpl_vars['projet']->value['couleur'];?>
" style="background-color:#<?php echo $_smarty_tpl->tpl_vars['projet']->value['couleur'];?>
;color:<?php echo buttonFontColor(('#').($_smarty_tpl->tpl_vars['projet']->value['couleur']));?>
" selected="selected"><?php echo $_smarty_tpl->tpl_vars['projet']->value['couleur'];?>
...
" />
		...
		<?php if ($_smarty_tpl->tpl_vars['projet']->value['lien'] != '') {?>
			<div class="col-md-2">
				<a class="btn btn-default tooltipster" title="<?php echo htmlspecialchars($_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'winProjet_gotoLien'), ENT_QUOTES, 'ISO-8859-1', true);?>
...
">
 ...
 :</label>
	...
	<div class="col-md-4 col-form-label"></div>
		<div class="col-md-8">
			<br />
			<input type="button" value="<?php echo htmlspecialchars($_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'enregistrer'), ENT_QUOTES, 'ISO-8859-1', true);?>
