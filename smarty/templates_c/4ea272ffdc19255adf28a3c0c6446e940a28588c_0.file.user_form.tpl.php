<?php
/* Smarty version 3.1.32, created on 2024-05-28 10:18:07
  from '/home/planning/public_html/templates/user_form.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.32',
  'unifunc' => 'content_6655933fa78fa2_86747287',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '4ea272ffdc19255adf28a3c0c6446e940a28588c' => 
    array (
      0 => '/home/planning/public_html/templates/user_form.tpl',
      1 => 1618499582,
      2 => 'file',
    ),
  ),
...
function content_6655933fa78fa2_86747287 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_checkPlugins(array(0=>array('file'=>'/home/planning/public_html/smarty/libs/plugins/modifier.replace.php','function'=>'smarty_modifier_replace',),));
?>
...
" maxlength="30" autocomplete="new-password" />
 ...
 :</label>
					...
					<div class="form-check form-check-inline">
						<input class="form-check-input" type="radio" name="users_manage" id="users_manage_team" value="users_manage_team" <?php if (in_array("users_manage_team",$_smarty_tpl->tpl_vars['user_form']->value['tabDroits'])) {?>checked="checked"<?php }?>>
						<label class="form-check-label" for="users_manage_team"><?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'droits_gererUsersTeam');?>
</label>
					</div>
					<div class="form-check form-check-inline">
						<input class="form-check-input" type="radio" name="users_manage" id="users_manage_all" value="users_manage_all" <?php if (in_array("users_manage_all",$_smarty_tpl->tpl_vars['user_form']->value['tabDroits'])) {?>checked="checked"<?php }?> <?php if (in_array("users_manage_team",$_smarty_tpl->tpl_vars['user']->value['tabDroits'])) {?>disabled<?php }?>>
 ...
 :</label>
					...
					<div class="form-check form-check-inline">
							<input class="form-check-input" type="radio" name="planning_modif" id="tasks_readonly" value="tasks_readonly" <?php if (in_array("tasks_readonly",$_smarty_tpl->tpl_vars['user_form']->value['tabDroits']) || (!in_array("tasks_modify_all",$_smarty_tpl->tpl_vars['user_form']->value['tabDroits']) && !in_array("tasks_modify_own_project",$_smarty_tpl->tpl_vars['user_form']->value['tabDroits']) && !in_array("tasks_modify_own_task",$_smarty_tpl->tpl_vars['user_form']->value['tabDroits']))) {?>checked="checked"<?php }?>>
						...
						<div class="form-check form-check-inline">
							<input class="form-check-input" type="radio" name="planning_modif" id="tasks_modify_team" value="tasks_modify_team" <?php if (in_array("tasks_modify_team",$_smarty_tpl->tpl_vars['user_form']->value['tabDroits'])) {?>checked="checked"<?php }?>>
							<label class="form-check-label" for="tasks_modify_team"><?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'droits_planningEquipe');?>
</label>
						</div><br />				
						<div class="form-check form-check-inline">
 ...
 :</label>
						...
						<div class="form-check form-check-inline">
							<input class="form-check-input" type="radio" name="planning_view_users" id="droits_tasks_view_team_users" value="droits_tasks_view_team_users" <?php if (in_array("droits_tasks_view_team_users",$_smarty_tpl->tpl_vars['user_form']->value['tabDroits'])) {?>checked="checked"<?php }?> onChange="if(this.checked){document.getElementById('divSpecificUsers').style.display='none';}">
							<label class="form-check-label" for="droits_tasks_view_team_users"><?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'droits_tasks_view_team_users');?>
</label>
						</div>
						<div class="form-check form-check-inline">
...
>
 ...
 :</label>
			...
			<?php if (!(in_array("users_manage_team",$_smarty_tpl->tpl_vars['user_form']->value['tabDroits']))) {?>
			<div class="row">
 ...
 :</label>
				...
				<div class="form-check form-check-inline">
					<input class="form-check-input" type="radio" name="visible_planning" id="visible_planningNon" value="non" <?php if ($_smarty_tpl->tpl_vars['user_form']->value['visible_planning'] == "non") {?>checked="checked"<?php }?>>
...
" class="form-control" >
							<?php if ($_smarty_tpl->tpl_vars['user_form']->value['couleur'] != '') {?><option value="#<?php echo $_smarty_tpl->tpl_vars['user_form']->value['couleur'];?>
" style="background-color:#<?php echo $_smarty_tpl->tpl_vars['user_form']->value['couleur'];?>
;color:<?php echo buttonFontColor(('#').($_smarty_tpl->tpl_vars['user_form']->value['couleur']));?>
" selected="selected"><?php echo $_smarty_tpl->tpl_vars['user_form']->value['couleur'];?>
</option><?php } else { ?><option value=""><?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'winProjet_couleurchoix');?>
</option><?php }?>
							<?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, explode(",",@constant('CONFIG_PROJECT_COLORS_POSSIBLE')), 'couleurTmp');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['couleurTmp']->value) {
?>
								<option value="<?php echo $_smarty_tpl->tpl_vars['couleurTmp']->value;?>
...
"/>
			...
			<?php if (@constant('CONFIG_GOOGLE_2FA_ACTIVE') == "1" && $_smarty_tpl->tpl_vars['user_form']->value['google_2fa'] == "ok") {?>
				<div class="form-group">
					<div class="col-md-12">
						<label class="checkbox-inline">
							<input type="checkbox" id="google_2fa_reset" name="google_2fa_reset" value="true" /><?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'google_2fa_reset');?>
