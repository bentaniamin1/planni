<?php
/* Smarty version 3.1.32, created on 2024-05-14 09:08:02
  from '/home/planning/public_html/templates/www_projets.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.32',
  'unifunc' => 'content_66430dd23020d5_47739401',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'be0714ea278245df8581295f5b93367df7236c73' => 
    array (
      0 => '/home/planning/public_html/templates/www_projets.tpl',
      1 => 1603874318,
      2 => 'file',
    ),
  ),
...
function content_66430dd23020d5_47739401 (Smarty_Internal_Template $_smarty_tpl) {
...
<div class="container">
 ...
 :</label>
					...
					<div class="btn-group">
					<button type="button" class="btn <?php if (count($_smarty_tpl->tpl_vars['filtreGroupeProjet']->value) > 0) {?>btn-danger<?php } else { ?>btn-default<?php }?> dropdown-toggle" data-toggle="dropdown" data-display="static"><?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'filtreGroupeProjet');?>
...
" class="btn btn-sm btn-primary ml-2 mt-2" /></li>
 ...
 :&nbsp;</label>
						<div class="input-group">
							<input type="text" name="nb_mois" class="form-control" size="1" value="<?php echo xss_protect($_smarty_tpl->tpl_vars['nbMois']->value);?>
" />
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
					...
					<div class="btn-group" id="projectSearchbox">
						<div class="input-group">
							<input type="text" class="form-control" name="rechercheProjet" value="<?php echo (($tmp = @xss_protect($_smarty_tpl->tpl_vars['rechercheProjet']->value))===null||$tmp==='' ? '' : $tmp);?>
		...
		<div class="col-md-12">
			<div class="soplanning-box mt-2">
				<table class="table table-striped table-hover" id="projectTab">
					<thead>
					<tr>
						<th colspan="" class="d-none d-md-table-cell"><?php echo count($_smarty_tpl->tpl_vars['projets']->value);?>
 <?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'projet_liste_projet');?>
</th>
						<th class="">
							<?php if ($_smarty_tpl->tpl_vars['order']->value == "projet_id") {?>
								<?php if ($_smarty_tpl->tpl_vars['by']->value == "asc") {?>
									<a href="?order=projet_id&by=desc"><?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'winProjet_identifiant');?>
</a>&nbsp;<img src="<?php echo $_smarty_tpl->tpl_vars['BASE']->value;?>
/assets/img/pictos/asc_order.png" alt="" />
								<?php } else { ?>
									<a href="?order=projet_id&by=asc"><?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'winProjet_identifiant');?>
</a>&nbsp;<img src="<?php echo $_smarty_tpl->tpl_vars['BASE']->value;?>
/assets/img/pictos/desc_order.png" alt="" />
								<?php }?>
							<?php } else { ?>
								<a href="?order=projet_id&by=<?php echo $_smarty_tpl->tpl_vars['by']->value;?>
"><?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'winProjet_identifiant');?>
</a>
							<?php }?>
						</th>
						<th class="">
							<?php if ($_smarty_tpl->tpl_vars['order']->value == "nom") {?>
								<?php if ($_smarty_tpl->tpl_vars['by']->value == "asc") {?>
									<a href="?order=nom&by=desc"><?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'winProjet_nomProjet');?>
</a>&nbsp;<img src="<?php echo $_smarty_tpl->tpl_vars['BASE']->value;?>
/assets/img/pictos/asc_order.png" alt="" />
								<?php } else { ?>
									<a href="?order=nom&by=asc"><?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'winProjet_nomProjet');?>
</a>&nbsp;<img src="<?php echo $_smarty_tpl->tpl_vars['BASE']->value;?>
/assets/img/pictos/desc_order.png" alt="" />
								<?php }?>
							<?php } else { ?>
								<a href="?order=nom&by=<?php echo $_smarty_tpl->tpl_vars['by']->value;?>
"><?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'winProjet_nomProjet');?>
</a>
							<?php }?>
						</th>
...
"><?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'projet_liste_livraison');?>
					...
					<tbody>
					<tr>
						<td colspan="7" class="project-group-head"><?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'projet_liste_sansGroupes');?>
</td>
					</tr>
...
?>
						<?php if ($_smarty_tpl->tpl_vars['projet']->value['groupe_id'] != $_smarty_tpl->tpl_vars['groupeCourant']->value) {?>
							<tr>
							<td colspan="7" class="project-group-head"><?php echo xss_protect($_smarty_tpl->tpl_vars['projet']->value['nom_groupe']);?>
</td>
						<?php }?>
						<tr>
							<td class="w140">
...
;display:inline-block;margin-left:20px" title="<?php echo $_smarty_tpl->tpl_vars['projet']->value['statut_nom'];?>
"></div>
								<?php }?>
							</td>
							<td>
								<span class="pastille-projet" style="background-color:#<?php echo $_smarty_tpl->tpl_vars['projet']->value['couleur'];?>
;color:<?php echo buttonFontColor(("#").($_smarty_tpl->tpl_vars['projet']->value['couleur']));?>
...
"><?php echo sqldate2userdate($_smarty_tpl->tpl_vars['projet']->value['livraison']);?>
							...
							<td class="wrap projectTabColComment">
								<?php $_smarty_tpl->_assignInScope('cooltip', (($_smarty_tpl->smarty->ext->configload->_getConfigVariable($_smarty_tpl, 'user_liste_NBPeriodes')).(" : ")).($_smarty_tpl->tpl_vars['projet']->value['totalPeriodes']));?>
...
"></span>
								&nbsp;&nbsp;&nbsp;
								<?php echo xss_protect($_smarty_tpl->tpl_vars['projet']->value['iteration']);?>
