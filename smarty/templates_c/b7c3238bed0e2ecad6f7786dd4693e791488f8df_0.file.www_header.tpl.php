...
/* Smarty version 3.1.32, created on 2024-05-14 09:04:02
  from '/home/planning/public_html/templates/www_header.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.32',
  'unifunc' => 'content_66430ce2c7cdb6_08154449',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'b7c3238bed0e2ecad6f7786dd4693e791488f8df' => 
    array (
      0 => '/home/planning/public_html/templates/www_header.tpl',
      1 => 1623273376,
      2 => 'file',
    ),
  ),
...
function content_66430ce2c7cdb6_08154449 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="fr">
<head>
...
>
	...
	<link rel="stylesheet" href="<?php echo $_smarty_tpl->tpl_vars['BASE']->value;?>
/assets/plugins/jquery-timepicker-1.11.15/jquery.timepicker.min.css" />
	<style>
...
px;
	...
	<?php }?>
	<?php if (@constant('CONFIG_PLANNING_CELL_FONTSIZE') > 0) {?>.cellHolidays,.cellProjectBiseau1,.cellProjectBiseau2,.cellProject{font-size:<?php echo @constant('CONFIG_PLANNING_CELL_FONTSIZE');?>
px;}
	<?php }?>
...
&nbsp;<span class="versionNumber">v<?php echo $_smarty_tpl->tpl_vars['infoVersion']->value;?>
</span></span>
		</a>

		<div id="divWarningSpace" style="width:15px">
			<div id="divWarningVersion" style="display:none">
				<a style="margin-left:5px" href="javascript:jQuery('#myModal .modal-header h5').html('<?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'version_version_dispo');?>
');jQuery('#myModal .modal-body').html(jQuery('#divContenuVersion').html());jQuery('#myModal').modal();undefined;"  title="<?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'warning_version');?>
" class="tooltipster">
...
/planning.php" id="menuPlanning" role="button" <?php if ($_SESSION['isMobileOrTablet'] == 1) {?>data-toggle="dropdown"<?php }?> >
...
/taches.php" class="dropdown-item">
			...
			<?php if (in_array("projects_manage_all",$_smarty_tpl->tpl_vars['user']->value['tabDroits']) || in_array("projects_manage_own",$_smarty_tpl->tpl_vars['user']->value['tabDroits'])) {?>
				<li class="nav-item dropdown">
					<a class="nav-link" href="<?php echo $_smarty_tpl->tpl_vars['BASE']->value;?>
/projets.php" id="menuProjet" <?php if ($_SESSION['isMobileOrTablet'] == 1) {?>data-toggle="dropdown"<?php }?> role="button">
...
/groupe_list.php" class="dropdown-item">
			...
			<?php }?>
			<?php if (in_array("users_manage_all",$_smarty_tpl->tpl_vars['user']->value['tabDroits']) || in_array("users_manage_team",$_smarty_tpl->tpl_vars['user']->value['tabDroits'])) {?>
				<li class="divider-vertical"></li>
				<li class="nav-item dropdown">
					<a class="nav-link" href="<?php echo $_smarty_tpl->tpl_vars['BASE']->value;?>
/user_list.php" id="menuUser" <?php if ($_SESSION['isMobileOrTablet'] == 1) {?>data-toggle="dropdown"<?php }?> role="button">
...
/user_groupes.php" class="dropdown-item">
			...
			<?php if (in_array("stats_users",$_smarty_tpl->tpl_vars['user']->value['tabDroits']) || in_array("stats_projects",$_smarty_tpl->tpl_vars['user']->value['tabDroits']) || in_array("audit_restore_own",$_smarty_tpl->tpl_vars['user']->value['tabDroits']) || in_array("audit_restore",$_smarty_tpl->tpl_vars['user']->value['tabDroits'])) {?>	
				...
				<li class="nav-item dropdown">
					<a class="nav-link" href="<?php echo $_smarty_tpl->tpl_vars['BASE']->value;?>
/stats_users.php" id="menuStats" role="button" <?php if ($_SESSION['isMobileOrTablet'] == 1) {?>data-toggle="dropdown"<?php }?> aria-haspopup="true" data-target="#menuStatsToggle" aria-expanded="true">
...
/audit.php" class="dropdown-item">
			...
			<?php if (in_array("parameters_all",$_smarty_tpl->tpl_vars['user']->value['tabDroits']) || in_array("lieux_all",$_smarty_tpl->tpl_vars['user']->value['tabDroits']) || in_array("ressources_all",$_smarty_tpl->tpl_vars['user']->value['tabDroits'])) {?>
				...
				<li class="nav-item dropdown">
					<a class="nav-link" href="<?php echo $_smarty_tpl->tpl_vars['BASE']->value;?>
/options.php" data-target="#menuOptionsToggle" id="menuOptions" <?php if ($_SESSION['isMobileOrTablet'] == 1) {?>data-toggle="dropdown"<?php }?> role="button">
...
/ressources.php" class="dropdown-item">
						...
						<div class="dropdown-divider"></div>
						<a href="<?php echo $_smarty_tpl->tpl_vars['BASE']->value;?>
/backup.php" class="dropdown-item">
							<i class="fa fa-exchange fa-lg fa-fw" aria-hidden="true"></i>&nbsp;&nbsp;<?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'menuImportExport');?>
...
if (isset($_smarty_tpl->tpl_vars['smartyData']->value['message']) || isset($_smarty_tpl->tpl_vars['smartyData']->value['erreur'])) {?>
	...
	<div class="container-fluid" style="margin-bottom:60px;">
		<div id="divMessage" class="alert <?php if ((isset($_smarty_tpl->tpl_vars['smartyData']->value['message']) && $_smarty_tpl->tpl_vars['smartyData']->value['message'] == 'changeNotOK') || isset($_smarty_tpl->tpl_vars['messageErreur']->value)) {?>alert-danger<?php } else { ?>alert-success<?php }?>">
